var Confirm = {
    ...
    addCustomButtons: function() {
        ...
        if (self.customButton)
           /* closeButton = '<button id="modal-close" type="button"  class="btn btn-default modal-custom-button  btn-primary">关闭</button>';*/
        	  closeButton = '<button id="modal-close"  class="btn btn-default modal-custom-button"  type="button" >关闭</button>';
        	else {
            self.customButton = {
                'Okay': {
                    'primary': true,
