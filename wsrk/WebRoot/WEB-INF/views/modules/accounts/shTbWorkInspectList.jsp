...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/accounts/tbWorkInspect/list?flag=2">部门落实党风廉政建设责任制年度量化考评表列表</a></li>
	</ul>
			...
			<tr>
				...
				<c:choose>
					    <c:when test="${tbWorkInspect.status == '6'}">
					     ...
					     <c:when test="${tbWorkInspect.status == '2'}">
				...
				<c:choose>
					    <c:when test="${tbWorkInspect.status == '2' || tbWorkInspect.status == '6'}">
