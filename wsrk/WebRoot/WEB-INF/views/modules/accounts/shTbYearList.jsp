...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/accounts/tbYear/list?flag=2">部门落实党风廉政建设责任制年度量化考评表列表</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="tbYear">
			<tr>
				...
				<c:choose>
					    <c:when test="${tbYear.status == '2' || tbYear.status == '6'}">
