...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/accounts/tbHalfyearTable/form?id=${tbHalfyearTable.id}">年度考评表<shiro:hasPermission name="accounts:tbHalfyearTable:edit">${not empty tbHalfyearTable.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="accounts:tbHalfyearTable:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
