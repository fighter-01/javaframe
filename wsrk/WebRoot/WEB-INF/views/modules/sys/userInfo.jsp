	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<%-- <div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="nameImage" type="images" uploadPath="/s" selectMultiple="false" maxWidth="100" maxHeight="100"/>
				<form:hidden id="nameImage" path="photo" htmlEscape="false" maxlength="255" class="input-xlarge"/>
				<sys:ckfinder input="nameImage" type="images" uploadPath="/9ebcd" selectMultiple="true" maxWidth="100" maxHeight="100"/>
