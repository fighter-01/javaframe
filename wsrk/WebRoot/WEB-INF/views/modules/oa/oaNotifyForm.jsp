	...
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<c:if test="${oaNotify.status ne '1'}">
			<div class="control-group">
				...
				<div class="controls">
					<input id="files" name="files" maxlength="255" class="input-xlarge" type="hidden" value="${oaNotify.files}">
					<form:hidden id="files" path="files" htmlEscape="false" maxlength="255" class="input-xlarge"/>
					<sys:ckfinder input="files" type="oaNotifyFiles" uploadPath="/oa/notify" selectMultiple="true"/>
				</div>
			</div>
			<div class="control-group">
		...
		<c:if test="${oaNotify.status eq '1'}">
			<div class="control-group">
				...
				<div class="controls">
					<form:hidden id="files" path="files" htmlEscape="false" maxlength="255" class="input-xlarge"/>
					<sys:ckfinder input="files" type="oaNotifyFiles" uploadPath="/oa/notify" selectMultiple="true" readonly="true" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">接受人：</label>
