		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:treeselect id="company" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.company.name}"
					title="支行" url="/sys/office/treeData?type=1" cssClass="required"/><br/>多选：<br/>
				...
				<sys:treeselect id="company2" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.company.name}"
					title="支行" url="/sys/office/treeData?type=1" cssClass="required" notAllowSelectParent="true" checked="true"/>
			</div>
		</div>
		<div class="control-group">
